...
@Component({
  selector: "app-home-style-single",
  templateUrl: "./single-product-style.component.html",
  styleUrls: ["./single-product-style.component.scss"],
})
export class SingleProductStyleComponent  {
