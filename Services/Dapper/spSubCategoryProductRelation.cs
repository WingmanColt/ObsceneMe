...
namespace Services
{
    public class spSubCategoryProductRelation : MainService, IspSubCategoryProductRelation
    {
        private string StoreName = "spSubCategoryProductRelation";

        public spSubCategoryProductRelation(IConfiguration config, ErrorLoggingService errorLogger) : base(config, errorLogger) { }
