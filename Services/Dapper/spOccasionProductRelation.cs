...
namespace Services
{
    public class spOccasionProductRelation : MainService, IspOccasionProductRelation
    {
        private string StoreName = "spOccasionProductRelation";

        public spOccasionProductRelation(IConfiguration config, ErrorLoggingService errorLogger) : base(config, errorLogger) { }
