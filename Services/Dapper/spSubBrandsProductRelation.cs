...
namespace Services
{
    public class spSubBrandsProductRelation : MainService, IspSubBrandsProductRelation
    {
        private string StoreName = "spSubBrandProductRelation";

        public spSubBrandsProductRelation(IConfiguration config, ErrorLoggingService errorLogger) : base(config, errorLogger) { }
