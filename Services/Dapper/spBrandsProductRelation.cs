...
namespace Services
{
    public class spBrandsProductRelation : MainService, IspBrandsProductRelation
    {
        private string StoreName = "spBrandProductRelation";

        public spBrandsProductRelation(IConfiguration config, ErrorLoggingService errorLogger) : base(config, errorLogger) { }
