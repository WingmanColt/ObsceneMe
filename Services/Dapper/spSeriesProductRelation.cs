...
namespace Services
{
    public class spSeriesProductRelation : MainService, IspSeriesProductRelation
    {
        private string StoreName = "spSeriesProductRelation";

        public spSeriesProductRelation(IConfiguration config, ErrorLoggingService errorLogger) : base(config, errorLogger) { }
